...
class RoverServiceTest {
    ...
    void parseBoard_InvalidBoardSize_BadFormat() {
        assertThrows(InputFormatException.class, () -> roverService.parseBoard(new BoardEntity(),"5 \n"), "The first line must contain the board upper-right coordinates, separated by a space");
        assertThrows(InputFormatException.class, () -> roverService.parseBoard(new BoardEntity()," \n"), "The first line must contain the board upper-right coordinates, separated by a space");
    }

    @Test
    void parseBoard_InvalidBoardSize_NotAnInteger() {
        assertThrows(InputFormatException.class, () -> roverService.parseBoard(new BoardEntity(),"5 A\n"), "The board height must be a positive integer");
        assertThrows(InputFormatException.class, () -> roverService.parseBoard(new BoardEntity(),"A A\n"), "The board width must be a positive integer");
    }

    @Test
    void parseBoard_InvalidBoardSize_NegativeInteger() {
        assertThrows(InputFormatException.class, () -> roverService.parseBoard(new BoardEntity(),"-5 5\n"), "The board width must be a positive integer");
        assertThrows(InputFormatException.class, () -> roverService.parseBoard(new BoardEntity(),"5 -5\n"), "The board height must be a positive integer");
    }
    ...
    {
        assertThrows(InputFormatException.class, () -> roverService.parseBoard(new BoardEntity(),"0 5\n"), "The board width and height must be integers greater than 0");
        assertThrows(InputFormatException.class, () -> roverService.parseBoard(new BoardEntity(),"5 0\n"), "The board width and height must be integers greater than 0");
    }
